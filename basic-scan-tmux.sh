...
# Last modified: Tue Apr 14, 2020  10:19PM
#      REVISION:  ---
#===============================================================================
...
alias dirb=gobuster
alias dirb=/root/amitag/git/tools/Scanning/ffuf/ffuf
...
then
    ...
    tpane  nmap -p- --min-rate=1000 -T4 -oA $odir/initial $ip ;ports=$(cat $odir/initial.nmap | grep ^[0-9] | cut -d '/' -f 1 | tr '\n' ',' | sed s/,$//);  nmap -sC -sV -p$ports -oA nmap/ports-scripts  $ip
